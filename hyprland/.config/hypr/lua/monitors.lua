...
hl.workspace_rule({ default = true, workspace = "1", monitor = "DP-1" })
hl.workspace_rule({ default = true, workspace = "10", monitor = "DP-2" })
hl.workspace_rule({ default = true, workspace = "9", monitor = "HDMI-A-1" })
