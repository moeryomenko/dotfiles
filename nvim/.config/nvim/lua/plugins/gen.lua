return {
	{
		...
		config = function()
			...
			gen.prompts.Create_Commit_Message_For_Code = { prompt = "Create commit message for this code:\n$text" }
			gen.prompts.Create_Commit_Message_For_Diff = { prompt = "Create commit message for this diff:\n$text" }
