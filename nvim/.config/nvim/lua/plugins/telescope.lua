return {
	...
	{
		src = "https://github.com/molecule-man/telescope-menufacture",
	},
	{
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "gf", ":Telescope git_files<CR>", { desc = "Telescope git files" })
			vim.keymap.set("n", "gb", ":Telescope buffers<CR>", { desc = "Telescope buffers" })
			vim.keymap.set("n", "rg", ":Telescope live_grep<CR>", { desc = "Telescope live grep" })
			vim.keymap.set("n", "gs", ":Telescope lsp_document_symbols<CR>", { desc = "Telescope document symbols" })
			vim.keymap.set("n", "grr", ":Telescope lsp_references<CR>", { desc = "Telescope references" })
			vim.keymap.set("n", "gri", ":Telescope lsp_implementations<CR>", { desc = "Telescope implementations" })
		end,
	},
}
