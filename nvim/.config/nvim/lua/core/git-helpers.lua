...
local popup = require("functions.popup")
...
vim.keymap.set("n", "]h", gitsigns.next_hunk) -- Next Change
vim.keymap.set("n", "[h", gitsigns.prev_hunk) -- Previous Change
...
vim.keymap.set("n", "<leader>gvv", function()
	M.view_changes()
end, map_opts)
