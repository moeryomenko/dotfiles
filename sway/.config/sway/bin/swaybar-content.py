...
def status():
    ...
    home_disk = bytes2human(disk_usage('/home/moeryomenko').free)
    ...
    values = (num_scratchpad(), root_disk, home_disk, brightness(), ip_address, source_volume(), sink_volume(), battery_capacity, battery_status, date)
